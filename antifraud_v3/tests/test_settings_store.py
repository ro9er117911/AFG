...
def test_save_settings_updates_the_cache_immediately(temp_settings):
    ...
    settings_store.save_settings({"debounce_chunks": 5})
    ...
    assert settings_store.load_settings()["debounce_chunks"] == 5
